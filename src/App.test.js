...
describe("<App />", () => {
    ...
    test("check if country changes when new lat and long is entered", async () => {
        ...
        await fireEvent.change(latitudeInput, {target: {value: 38}})
        await fireEvent.change(longitudeInput, {target: {value: 35}})
        ...
        await fireEvent.change(latitudeInput, {target: {value: 10}})
        await fireEvent.change(longitudeInput, {target: {value: 20}})
